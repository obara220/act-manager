            ...
            <div className="p-6 w-full pr-6 pl-6">
                ...
                <div className="flex justify-between grid grid-cols-3 gap-4 text-center border-b pb-4 flight-details-container">
                    <div className="col-span-3 col-span-3-layout mb-4">
                        ...
                        <div onClick={onManagerDetail} className="justify-between p-3 rounded-lg flex items-center more-detail-button">
                            <div>
                        ...
                        <div onClick={onSuperAdmin} className="justify-between p-3 mt-4 rounded-lg flex items-center more-detail-button">
                            <div>
