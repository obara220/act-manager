...
import { FaInfoCircle, FaSearch, FaArrowLeft, FaTimes } from "react-icons/fa";
            ...
            <div className="p-6 w-full pr-6 pl-6">
                ...
                <div className="driver-content m-4">
                    <div className="driver-container mr-4">
                        <div onClick={handleBack} className="flex justify-between items-center w-20 mb-4 cursor-pointer">
                            <FaArrowLeft />
                            <span>Back</span>
                        </div>
                        <div>
                            ...
                            <p>
                                Access detailed reports on drivers, vehicles, schedules, and financial performance—all in one place.
                            </p>
                        </div>
                    </div>
                    <div className="w-60 departure-custom-card rounded-lg">
                        <div className="flex justify-between">
                            ...
                            <div className="w-50">
                                ...
                                <div className="flex justify-between mb-2">
                                    ...
                                    <div>
                                        <select className="custom-input rounded-lg">
                                            <option>1002-FORD-TRANSIT</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between mb-2">
                                    ...
                                    <div>
                                        <select className="custom-input rounded-lg">
                                            <option>AA Traning Center</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex justify-between mb-2">
                            <div className="justify-between p-2 rounded-lg flex items-center custom-button">
                                <span>Search</span>
                            </div>
                            <div className="justify-between pl-20 pr-20 p-2 rounded-lg flex items-center custom-white-button">
                                <span>Clear</span>
                            </div>
                            <div className="justify-between p-2 rounded-lg flex items-center custom-white-button">
